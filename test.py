...
wait = {
    ...
    "selfbot":True,
    "mention":"NGINTIPPP!!!",
    "Respontag":"�w�w �ڬO�����}�o����½�Ĥ@�N\n�p���@�� https://line.me/ti/p/4-LFlTx31f",
    "welcome":"�w��",
    "comment":"Like like & like",
    "message":"�w�w �P�±z�[�ڦn��\n�ڪ��@��:���� https://line.me/ti/p/4-LFlTx31f",
    }
...
def waktu(secs):
    ...
    return '%02d �� %02d �p�� %02d ���� %02d ��' % (days, hours, mins, secs)
